 ...
 * како ги баравте ? 
   * Ги испробав двете комади sublist3r за да ги пронајдам subdomain-ите 
...
* 2FA (дво-факторска автентикација), дури и да влезе некој без вторниот фактор нема да може да пристапи.
* Да конфигурирање правила на firewall-от, за забрана на одредени IP адреси ако приметиме дека пробуваат активно да пристапат